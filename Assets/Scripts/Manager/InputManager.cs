...
public class InputManager : MonoBehaviour
{
    ...
    private const string PLAYER_PREFS_BLINDINGS = "InputBindings";
    ...
    private void EnableInputActions()
    {
        ...
        if (PlayerPrefs.HasKey(PLAYER_PREFS_BLINDINGS)) {
            playerInputActions.LoadBindingOverridesFromJson(PlayerPrefs.GetString(PLAYER_PREFS_BLINDINGS));
        }
    ...
    public void RebindBinding(Binding binding, Action onActionRebound)
    {
        ...
        inputAction.PerformInteractiveRebinding(bindingIndex)
            .OnComplete(callback =>
            {
                ...
                PlayerPrefs.SetString(PLAYER_PREFS_BLINDINGS,playerInputActions.SaveBindingOverridesAsJson());
                PlayerPrefs.Save();
            })
            .Start();
    }
